...
if UIA_support:
    ...
    class UIAWrapperTests(unittest.TestCase):
        ...
        def _find_nontop_ctl_by_class_name_and_title(self):
        ...
        def _find_top_win_by_class_name_and_title(self):
        ...
        def _is_keyboard_focusable(self):
        ...
        def _no_pattern_interface_error(self):
        ...
        def _get_legacy_properties(self):
    ...
    class UiaControlsTests(unittest.TestCase):
        ...
        def _friendly_class_names(self):
        ...
        def _combobox_expand_collapse(self):
    ...
    class MenuWrapperWpfTests(unittest.TestCase):
        ...
        def _menu_by_best_match_text(self):
    ...
    class TreeViewWpfTests(unittest.TestCase):
        ...
        def _tv_item_count_and_roots(self):
