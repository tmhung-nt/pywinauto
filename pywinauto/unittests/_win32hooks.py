...
class Win32HooksTests(unittest.TestCase):
    ...
    def _keyboard_hook_unicode_sequence(self):
    ...
    def _keyboard_hook_parallel_pressed_keys(self):
...
class Win32HooksWithMocksTests(unittest.TestCase):
    ...
    def _keyboard_hook_exception(self):
    ...
    def _mouse_hook_exception(self):
    ...
    def _listen_loop(self, mock_is_hooked, mock_process_msgs):
    ...
    def _process_win_msg(self, mock_stop):
